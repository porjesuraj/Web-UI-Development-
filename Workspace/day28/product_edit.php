...
<body onload="getProductDetails()">
  ...
  <div class="container">
    ...
    <input type="hidden" id="product-id" value="<?= $_GET["id"] ?>">
  </div>
  ...
  <script>
    ...
    function getProductDetails() {
      ...
      $.get('api/product_details.php?productId=' + productId, function(response) {
    ...
    function updateProduct() {
      ...
      $.post('api/product_edit.php', body, function(response) {
        const result = JSON.parse(response)
        if (result['status'] == 'success') {
